...
require 'vendor/autoload.php';
 \Stripe\Stripe::setApiKey('sk_test_51L41u9BvZ1aJbSFtvPGvWZ0YyV3LpAbGAaPf5UBT8R1aHXNF33mZMQBFj7CTW43s2aFsAiTbvFEJSKJsiLWysIF500DgcgjGGx');
  ...
  $checkout_session = \Stripe\Checkout\Session::create([
      'success_url' => 'http://localhost/pagamento.php',
      'cancel_url' => 'http://localhost/index.html',
      'payment_method_types' => ['card'],
      'mode' => 'subscription',
      'line_items' => [[
        'price' => "price_1LC6MEBvZ1aJbSFt0rWWb2oh",
...
<body>
  <script type="text/javascript">
     var stripe = Stripe('pk_test_51L41u9BvZ1aJbSFtesfY3mGS9EpeB8XzuexSxSIGVnWhAGnpWzb0SVMO2equbRWICLjMAypHmeWV0UxkTNi2buoQ00X8chRssF');
