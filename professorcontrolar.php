...
<body>
  ...
  <div class="content">
    <h1 id="apresentacao">Lista de Professores</h1>
    <div class="container">
    ...
    <div class="btn-buscar-top" id="search"></div></div>
      ...
      <?php
$sql1 = "SELECT count(*) as Ativo FROM professor   WHERE CondicaoP='Ativo'";
$sql2 = "SELECT count(*) as Inativo  FROM professor WHERE CondicaoP='Inativo'";
